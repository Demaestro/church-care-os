...
const englishDictionary = {
  layout: {
    brandKicker: "FirstLove",
    brandTitle: "Assembly Platform",
    signIn: "Sign in",
    signOut: "Sign out",
    ...
    nav: {
      ...
      people: "Staff & Users",
      reports: "Reports",
      leaderView: "Care board",
      schedule: "Schedule",
      households: "Households",
      volunteerView: "Volunteers",
    ...
    publicEntryTitle: "Every member connected in one place.",
    publicEntryBody:
      "Request support, track your case, or log into your member profile without needing to call or visit the office.",
    internalEntryTitle: "Switch between ministry roles seamlessly.",
    internalEntryBody:
      "Move between administrator, pastor, leader, and volunteer views to review how each team member experiences the platform.",
    footerPrimary:
      "FirstLove Assembly — one platform for every ministry, campus, and calling.",
    footerSecondary:
      "People, worship, finance, and care — all in one connected ecosystem.",
  },
  displayModes: {
    standard: "Standard",
...
const translatedDictionaries = {
  ig: {
    ...
    displayModes: {
      standard: "Nke nká»‹tá»‹",
      comfort: "Nke di mfe / mkpá»¥rá»¥ okwu buru ibu",
    },
    requestNew: {
      kicker: "Nnata ndi otu",
      title: "Ria nlekota nâ€™enweghi ibu uzo ulo uka mara tupu oge eruo.",
      description:
        "Onye ukochukwu ma obu onye ndu nlekota na-enyocha aririo obula tupu ekenye ya nâ€™uzo sara mbara. Nhá»rá» nzuzo di nâ€™ime form a ka onye otu wee kpebie nkwenye ozugbo.",
      trackRequest: "Soro aririo",
      permissions: "Lee matriks ikike",
    },
    requestStatusPage: {
      kicker: "Onye otu nâ€™onwe ya",
      title: "Lelee ebe aririo nlekota gi ruru.",
      description:
        "Jiri koodu nsonye i nwetara ka i wee hu nlele zuru udo ma nwekwa nchekwa nâ€™enweghi login.",
      submitCareRequest: "Zipu aririo nlekota",
      accountRecovery: "Nwegharia akaá»¥ntá»¥",
    },
    loginPage: {
      signIn: "Banye",
      welcomeBack: "Nná»á» á»zá»",
      needRecovery: "Chá»rá» iweghachi akaá»¥ntá»¥?",
    },
    recoveryPage: {
      title: "Rá»‹á» maka iweghachi akaá»¥ntá»¥.",
      backToSignIn: "Laa na nbanye",
    },
  },
  yo: {
    layout: {
      brandTitle: "Páº¹páº¹ iá¹£áº¹",
      signIn: "Wá»le",
      signOut: "Jade",
      preferencesTitle: "Ede ati iwá»n á»rá»",
      preferencesBody:
        "Yan ede ti o fáº¹ ki o si jáº¹ ki á»rá» rá»run lati ka.",
      languageLabel: "Ede",
      textSizeLabel: "Iwá»n á»rá»",
      applyPreferences: "Lo ayipada",
      nav: {
        dashboard: "Páº¹páº¹ iá¹£akoso",
        requestCare: "Beere iranlá»wá»",
        trackRequest: "Táº¹le Ã¬bÃ©Ã¨rÃ¨",
        permissions: "Ã€á¹£áº¹",
        signIn: "Wá»le",
        teams: "Awá»n áº¹gbáº¹",
        people: "Awá»n eniyan",
        reports: "Ã€wá»n Ã¬rÃ²yÃ¬n",
        leaderView: "Wiwo olori",
        households: "Awá»n idile",
        volunteerView: "Wiwo oluyá»á»da",
        notifications: "Ã€wá»n Ã¬firaná¹£áº¹",
        audit: "Ayáº¹wo",
        settings: "ÃˆtÃ²",
      },
      footerPrimary:
        "A ká» á» fun awá»n áº¹gbáº¹ itá»ju ti wá»n fáº¹ kedere, Ã¬fáº¹Ì, ati awá»n handoff ti ko sá»nu.",
      footerSecondary:
        "Awá»n pastor, deacon, ati awá»n oluyá»á»da wa ninu Ã¬á¹£ipopada kan ti o han gbangba.",
    },
    displayModes: {
      standard: "Deede",
      comfort: "Rá»run / á»rá» tobi",
    },
    requestNew: {
      kicker: "Fá»á»mu á»má» ijá»",
      title: "Beere iranlá»wá» laisi ká»ká» má» gbogbo eto ijá».",
      trackRequest: "Táº¹le Ã¬bÃ©Ã¨rÃ¨",
      permissions: "Wo matriki Ã á¹£áº¹",
    },
    requestStatusPage: {
      kicker: "Iá¹£áº¹ ara áº¹ni",
      title: "Wo ibi ti Ã¬bÃ©Ã¨rÃ¨ iranlá»wá» ráº¹ wa.",
      submitCareRequest: "Firaná¹£áº¹ Ã¬bÃ©Ã¨rÃ¨ iranlá»wá»",
  ...
  ha: {
    layout: {
      ...
      preferencesBody:
        "ZaÉ“i harshen da kake so kuma ka sa rubutu ya fi sauÆ™in karantawa.",
    ...
    displayModes: {
      ...
      comfort: "Mai sauÆ™i / rubutu babba",
    },
    requestNew: {
      kicker: "Shigar mamba",
  ...
  es: {
    layout: {
      ...
      preferencesTitle: "Idioma y tamaÃ±o del texto",
      preferencesBody:
        "Elige tu idioma y haz que el texto sea mÃ¡s fÃ¡cil de leer.",
      languageLabel: "Idioma",
      textSizeLabel: "TamaÃ±o del texto",
    ...
    displayModes: {
      standard: "EstÃ¡ndar",
      comfort: "CÃ³modo / texto grande",
    },
    requestNew: {
      kicker: "Formulario de miembro",
      title: "Pide cuidado sin tener que entender primero toda la estructura de la iglesia.",
      description:
        "Un pastor o lÃ­der de cuidado revisa cada solicitud antes de derivarla. Las opciones de privacidad estÃ¡n en este formulario para que la persona decida su consentimiento al enviarlo.",
    ...
    requestStatusPage: {
      ...
      description:
        "Usa el cÃ³digo de seguimiento para ver un progreso claro y privado sin iniciar sesiÃ³n.",
      submitCareRequest: "Enviar solicitud de cuidado",
      accountRecovery: "RecuperaciÃ³n de cuenta",
    },
    loginPage: {
      kicker: "Acceso interno",
      title: "Inicia sesiÃ³n antes de abrir los flujos internos de cuidado.",
      description:
        "Las pantallas de pastor, lÃ­der, dueÃ±o y voluntario estÃ¡n protegidas con controles de acceso por rol.",
      welcomeBack: "Bienvenido de nuevo",
      useAssignedAccount: "Usa la cuenta asignada a tu funciÃ³n de cuidado.",
      needRecovery: "Â¿Necesitas recuperar tu cuenta?",
    ...
    loginForm: {
      ...
      passwordPlaceholder: "Escribe tu contraseÃ±a",
      signIn: "Iniciar sesiÃ³n",
      signingIn: "Entrando...",
    },
    recoveryPage: {
      title: "Solicitar recuperaciÃ³n de cuenta.",
  ...
  fr: {
    layout: {
      brandTitle: "Tableau des opÃ©rations",
      signIn: "Se connecter",
      signOut: "Se dÃ©connecter",
      preferencesTitle: "Langue et taille du texte",
      preferencesBody:
        "Choisissez votre langue et rendez le texte plus facile Ã  lire.",
      languageLabel: "Langue",
      textSizeLabel: "Taille du texte",
      applyPreferences: "Appliquer",
      nav: {
        dashboard: "Tableau",
        requestCare: "Demander de lâ€™aide",
    ...
    requestNew: {
      ...
      title: "Demandez de lâ€™aide sans devoir comprendre dâ€™abord toute la structure de lâ€™Ã©glise.",
      trackRequest: "Suivre une demande",
      permissions: "Voir la matrice des autorisations",
    },
    requestStatusPage: {
      kicker: "Libre-service membre",
      title: "VÃ©rifiez lâ€™Ã©tat de votre demande dâ€™aide.",
      submitCareRequest: "Envoyer une demande dâ€™aide",
      accountRecovery: "RÃ©cupÃ©ration de compte",
    },
    loginPage: {
      welcomeBack: "Bon retour",
      needRecovery: "Besoin de rÃ©cupÃ©rer votre compte ?",
    },
  },
};
